cmd_spl/arch/arm/lib/debug.o := arm-none-linux-gnueabi-gcc -Wp,-MD,spl/arch/arm/lib/.debug.o.d  -nostdinc -isystem /usr/local/arm/gcc-4.6.2-glibc-2.13-linaro-multilib-2011.12/fsl-linaro-toolchain/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.6.2/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__  -DCONFIG_SPL_BUILD -D__ASSEMBLY__      -D__ARM__ -Wa,-mimplicit-it=always  -mthumb -mthumb-interwork  -mabi=aapcs-linux   -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -fno-optimize-sibling-calls -pipe  -march=armv7-a       -c -o spl/arch/arm/lib/debug.o arch/arm/lib/debug.S

source_spl/arch/arm/lib/debug.o := arch/arm/lib/debug.S

deps_spl/arch/arm/lib/debug.o := \
...
spl/arch/arm/lib/debug.o: $(deps_spl/arch/arm/lib/debug.o)
